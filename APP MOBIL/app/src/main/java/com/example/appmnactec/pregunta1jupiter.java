...
public class pregunta1jupiter extends AppCompatActivity implements View.OnClickListener {
    Button a,b,c,d;
    ImageButton sig;
    Preguntes lista;
    int calificaion=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i = new Intent(pregunta1jupiter.this, pregunta2jupiter.class);
        ...
        pos = Preguntes.buscarPre(lista,7,dificultat);
