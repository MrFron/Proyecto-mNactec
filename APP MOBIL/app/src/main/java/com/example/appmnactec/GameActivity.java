...
public void letterPressed(View view){
        ...
        if(correct){
            ...
            if(numCorr==numChars){
                Pantallafinal.setPuntuacion(Pantallafinal.getPuntuacion()+50);
                disableButtons();
                AlertDialog.Builder builder=new AlertDialog.Builder(this);

                builder.setTitle(Html.fromHtml("<big>GANASTE</big>"));
                builder.setMessage((Html.fromHtml("<big>¡FELICIDADES!</big> \n\n <big>LA RESPUESTA ERA</big> \n\n"+"<big>"+currWord+"</big>" )));
                builder.setPositiveButton(Html.fromHtml("<big>JUGAR DE NUEVO</big>"), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                      GameActivity.this.playGame();
                    }
                });
                builder.setNegativeButton(Html.fromHtml("<big>SALIR</big>"), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        intent = new Intent(GameActivity.this, MenuAgujero.class);
            ...
            builder.setTitle(Html.fromHtml("<big>PERDISTE</big>"));
            builder.setMessage((Html.fromHtml("<big>LA RESPUESTA ERA</big> \n\n"+"<big>"+currWord+"</big>" )));
            builder.setPositiveButton(Html.fromHtml("<big>JUGAR DE NUEVO</big>"), new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    GameActivity.this.playGame();
