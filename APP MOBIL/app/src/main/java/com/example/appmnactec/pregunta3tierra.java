...
public class pregunta3tierra extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i = new Intent(pregunta3tierra.this, score.class);
        ...
        pos = Preguntes.buscarPre(lista,3,dificultat);
