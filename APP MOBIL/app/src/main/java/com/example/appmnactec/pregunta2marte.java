...
public class pregunta2marte extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i = new Intent(pregunta2marte.this, pregunta3marte.class);
        ...
        pos = Preguntes.buscarPre(lista,5,dificultat);
